...
const char* ssid = "Ngoc Thao";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "01672639857";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "iotappweb.herokuapp.com";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
